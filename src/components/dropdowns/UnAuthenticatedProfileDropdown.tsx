...
const UnAuthenticatedProfileDropdown = React.forwardRef<HTMLDivElement>(
  ({}, ref) => {
    return (
      <div
        ref={ref}
...
UnAuthenticatedProfileDropdown.displayName = "UnAuthenticatedProfileDropdown";

export default UnAuthenticatedProfileDropdown;
