...
import SelectTags from "../inputs/SelectTag";
import SelectSeries from "../inputs/Series";
import { type ArticleData } from "../pages/new/NewArticleBody";
...
interface Props {
  ...
  setGeneratingContent: React.Dispatch<
        ...
        <main className="px-2 py-4 pt-4">
          ...
          <div className="w-full">
            <div className="mb-8">
              ...
              <div className="relative flex items-stretch gap-2 rounded-md border border-border-light bg-white dark:border-border dark:bg-slate-800 md:px-4 ">
            ...
            <div className="mb-8">
              ...
              <div className="rix_ai_input relative">
                <div
                  className="rix_ai_button"
                  title="Generate Seo title using AI"
                >
                  <button
                    onClick={async () => {
                      if (!data.title) {
                    ...
                    className="absolute right-2 top-1/2 -translate-y-1/2 rounded-full bg-white p-2 transition duration-150 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-800"
                  >
            ...
            <div className="mb-8">
              ...
              <div className="rix_ai_input relative">
                <div
                  className="rix_ai_button"
                  title="Generate Seo Description using AI"
                >
                  <button
                    onClick={async () => {
                      if (!data.title) {
                    ...
                    className="absolute right-2 top-2 rounded-full bg-white p-2 transition duration-150 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-800"
                  >
                ...
                <div className="">
                  <textarea
                    className="input-secondary min-h-[12rem]  bg-white dark:bg-slate-800"
