          ...
          <div className="rix_ai_input relative">
            <div className="rix_ai_button" title="Generate Title using AI">
              <button
                ...
                className="absolute -left-12 top-1/2 -translate-y-1/2 rounded-full bg-transparent p-2 transition duration-150 hover:bg-slate-200 dark:hover:bg-slate-800"
              >
          ...
          <div className="rix_ai_input relative">
            <div className="rix_ai_button" title="Generate Content using AI">
              <button
                ...
                className="absolute -left-12 top-2 rounded-full bg-transparent p-2 transition duration-150 hover:bg-slate-200 dark:hover:bg-slate-800"
              >
                {generatingContent.title ? (
                  <LoadingSpinner className="h-5 w-5 fill-none stroke-slate-800" />
                ) : (
